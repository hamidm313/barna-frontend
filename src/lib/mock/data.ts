...
export const mockEthnicGroups: EthnicGroup[] = [
  { id: 1, uuid: 'uuid-eg-1', display_name: 'آذری', slug: 'azari', description: 'پوشاک سنتی و رنگارنگ مردم آذربایجان با نقوش هندسی زیبا و رنگ‌های شاد', image: 'https://images.unsplash.com/photo-1594908900066-3f47337549d8?w=800', display_order: 1, is_active: true },
  { id: 2, uuid: 'uuid-eg-2', display_name: 'لری', slug: 'lori', description: 'لباس‌های بومی استان‌های لرستان و چهارمحال با پارچه‌های دستباف و رنگ‌های طبیعی', image: 'https://images.unsplash.com/photo-1617196034183-421b4040ed20?w=800', display_order: 2, is_active: true },
  { id: 3, uuid: 'uuid-eg-3', display_name: 'کردی', slug: 'kurdi', description: 'جامه‌های رنگین کردستان و کرمانشاه با گلدوزی‌های دستی بی‌نظیر', image: 'https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=800', display_order: 3, is_active: true },
  { id: 4, uuid: 'uuid-eg-4', display_name: 'بوشهری', slug: 'bushehri', description: 'پوشاک گرمسیری استان بوشهر با طرح‌های دریایی و پارچه‌های سبک', image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800', display_order: 4, is_active: true },
  { id: 5, uuid: 'uuid-eg-5', display_name: 'ترکمن', slug: 'turkmen', description: 'لباس‌های جلفا و گرگان با نقوش ابریشمی و رنگ‌های گرم', image: 'https://images.unsplash.com/photo-1503174971373-b1f69850bded?w=800', display_order: 5, is_active: true },
  { id: 6, uuid: 'uuid-eg-6', display_name: 'بندری', slug: 'bandari', description: 'جامه‌های مخصوص بنادر جنوبی با برقع و دامن‌های چین‌دار رنگارنگ', image: 'https://images.unsplash.com/photo-1600880292203-757bb62b4baf?w=800', display_order: 6, is_active: true },
  { id: 7, uuid: 'uuid-eg-7', display_name: 'عربی', slug: 'arabi', description: 'پوشاک سنتی عرب‌های خوزستان و هرمزگان با دشداشه و عبا', image: 'https://images.unsplash.com/photo-1563178406-4cdc2923acbc?w=800', display_order: 7, is_active: true },
  { id: 8, uuid: 'uuid-eg-8', display_name: 'مدرن برنا', slug: 'barna-modern', description: 'طرح‌های ترکیبی مدرن برنا با الهام از سنت ایرانی و نگاه به آینده', image: 'https://images.unsplash.com/photo-1558769132-cb1aea458c5e?w=800', display_order: 8, is_active: true },
];
...
export const mockMedia: MediaItem[] = [
  { id: 1, filename: 'azari-1.jpg', original_name: 'لباس آذری.jpg', url: 'https://images.unsplash.com/photo-1594908900066-3f47337549d8?w=800', cdn_provider: 'local', size: 245000, mime_type: 'image/jpeg', tags: ['آذری', 'عروسی'], created_at: '2024-01-10T00:00:00Z', type: 'image' },
  { id: 2, filename: 'lori-1.jpg', original_name: 'جامه لری.jpg', url: 'https://images.unsplash.com/photo-1617196034183-421b4040ed20?w=800', cdn_provider: 'local', size: 312000, mime_type: 'image/jpeg', tags: ['لری'], created_at: '2024-01-15T00:00:00Z', type: 'image' },
  { id: 3, filename: 'kurdi-1.jpg', original_name: 'کرت کردی.jpg', url: 'https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=800', cdn_provider: 'local', size: 198000, mime_type: 'image/jpeg', tags: ['کردی', 'ابریشم'], created_at: '2024-02-01T00:00:00Z', type: 'image' },
  { id: 4, filename: 'bandari-1.jpg', original_name: 'لباس بندری.jpg', url: 'https://images.unsplash.com/photo-1600880292203-757bb62b4baf?w=800', cdn_provider: 'local', size: 276000, mime_type: 'image/jpeg', tags: ['بندری'], created_at: '2024-02-10T00:00:00Z', type: 'image' },
  { id: 5, filename: 'turkmen-1.jpg', original_name: 'ترکمن.jpg', url: 'https://images.unsplash.com/photo-1503174971373-b1f69850bded?w=800', cdn_provider: 'local', size: 321000, mime_type: 'image/jpeg', tags: ['ترکمن'], created_at: '2024-03-01T00:00:00Z', type: 'image' },
  { id: 6, filename: 'barna-fusion-1.jpg', original_name: 'فیوژن برنا.jpg', url: 'https://images.unsplash.com/photo-1558769132-cb1aea458c5e?w=800', cdn_provider: 'local', size: 289000, mime_type: 'image/jpeg', tags: ['برنا', 'فیوژن', 'مدرن'], created_at: '2024-03-10T00:00:00Z', type: 'image' },
  { id: 7, filename: 'arabic-1.jpg', original_name: 'دشداشه عربی.jpg', url: 'https://images.unsplash.com/photo-1563178406-4cdc2923acbc?w=800', cdn_provider: 'local', size: 234000, mime_type: 'image/jpeg', tags: ['عربی'], created_at: '2024-03-20T00:00:00Z', type: 'image' },
  { id: 8, filename: 'bushehri-1.jpg', original_name: 'بوشهری.jpg', url: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800', cdn_provider: 'local', size: 267000, mime_type: 'image/jpeg', tags: ['بوشهری', 'جنوب'], created_at: '2024-04-01T00:00:00Z', type: 'image' },
];
...
export const mockCommunityPosts: CommunityPost[] = [
  { id: 1, user_id: 2, user_display_name: 'علی محمدی', content: 'تازه لباس عروس آذری رو اجاره کردم برای مراسم. کیفیت فوق‌العاده بود!', images: ['https://images.unsplash.com/photo-1594908900066-3f47337549d8?w=400'], status: 'approved', created_at: '2024-06-05T00:00:00Z' },
